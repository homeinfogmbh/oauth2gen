...
def query_client(client: Type[Model], client_id: str) -> Optional[Model]:
...
def save_token(token: Type[Model], token_data: dict, request: Any) -> None:
    ...
    token(client_id=request.client.client_id, user_id=user_id, **token_data).save()
